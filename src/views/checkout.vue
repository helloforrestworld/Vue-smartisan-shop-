          ...
          <div class="invoice-detail"> 发票抬头： 
            <div class="radio-box"> 
              <label> 
                ...
                <span class="blue-radio":class="{'blue-radio-on':invoice.personal}"@click="tabInvoice(true)">
                  <a></a>
                </span>  个人
              </label> 
              <label> 
                <input type="radio" class="hide"> 
                <span class="blue-radio":class="{'blue-radio-on':!invoice.personal}"@click="tabInvoice(false)">
                  <a></a>
                </span>  单位
              </label> 
            </div> 
            <div class="module-form-row form-item fn-hide js-invoice-title" v-show="!invoice.personal"> 
              <div class="module-form-item-wrapper no-icon small-item"> 
                ...
                <div class="verify-error" v-show="invoice.name == ''">
                  必填
                </div>
              </div> 
            </div> 
